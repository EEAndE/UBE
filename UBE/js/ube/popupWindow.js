...
async function getCurrentTab() {
    try {
        ...
        throw new Error("Failed to extract current tab information for popup", {cause: error});
    }
}
...
function displayResultsData(data) {
    ...
    if (resultData && typeof resultData === 'object') {
        for (const [key, value] of Object.entries(resultData)) {
            if (['timestamps', 'executionTimes', 'url', 'prediction'].includes(key.toLowerCase())) continue;
